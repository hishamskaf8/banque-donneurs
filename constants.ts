...
export const TRANSLATIONS = {
  ar: {
    ...
    table: {
      ...
      ineligible: "بطاقة مجمدة مؤقتاً",
      ineligibleReason: "يجب انقضاء 4 أشهر على الأقل منذ آخر تبرع.",
      eligible: "متاح للتبرع",
      daysLeft: "بقي {days} يوم",
      frozenUntil: "متاح بتاريخ {date}",
      waitProgress: "فترة الانتظار:",
      donatedToday: "تبرع اليوم",
      donatedRecently: "تبرع مؤخراً",
    },
    footerContact: "اتصل بنا",
    footerRights: "الهلال الأحمر الجزائري - سيدي بلعباس. جميع الحقوق محفوظة 2026 ©",
  ...
  fr: {
    ...
    table: {
      ...
      ineligible: "Carte gelée temporairement",
      ineligibleReason: "Minimum 4 mois depuis le dernier don.",
      eligible: "Éligible au don",
      daysLeft: "{days} jours restants",
      frozenUntil: "Disponible le {date}",
      waitProgress: "Période d'attente :",
      donatedToday: "Don d'aujourd'hui",
      donatedRecently: "Don récent",
    },
    footerContact: "Nous contacter",
    footerRights: "Croissant-Rouge Algérien - Sidi Bel Abbès. 2026 ©",
